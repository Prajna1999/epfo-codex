...
const dict: Record<string, { en: string; hi: string }> = {
  ...
  "Establishment": { en: "Establishment", hi: "प्रतिष्ठान" },
  "Principal employer": { en: "Principal employer", hi: "प्रधान नियोक्ता" },
  ...
  "Mock workspace": { en: "Mock workspace", hi: "मॉक वर्कस्पेस" },
  "EMPLOYER PORTAL": { en: "EMPLOYER PORTAL", hi: "नियोक्ता पोर्टल" },
  "Welcome back": { en: "Welcome back", hi: "वापसी पर स्वागत है" },
  "Authorised access": { en: "Authorised access", hi: "अधिकृत प्रवेश" },
